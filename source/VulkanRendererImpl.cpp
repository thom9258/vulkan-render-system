...
void PresentationContext::Impl::CreateCommandpool()
{
...
void PresentationContext::Impl::CreateCommandbuffers()
{
...
void
PresentationContext::Impl::RecordBlitTextureToSwapchain(vk::CommandBuffer& commandbuffer,
